...
<title>Registo de Professor</title>
...
if ($_POST['cadastrar']) {
	...
	if (!empty($foto["name"])) {
		...
		if (count($error) == 0) {
        	...
        	$caminho_imagem = "I:\PAT Criacao Sistema Almocos RFID\wamp\www\\fotos_prof\\"  . $nome_imagem;
 
			// Faz o upload da imagem para seu respectivo caminho
			move_uploaded_file($foto["tmp_name"], $caminho_imagem);
 
			// Insere os dados no banco
			$sql = mysql_query("INSERT INTO professores VALUES ('".$rfid."', '".$proc."', '".$nome."', '".$password."', '".$nome_imagem."')");
...
?>
</div>  <!--tudo o que for do site parte principal e ate aqui-->
    	<div id= "sidebar">
        <h1>Esta Semana:</h1>
        <br />
        <h2>Segunda-Feira:</h2>
