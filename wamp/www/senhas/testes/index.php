...
$query = "SELECT event_id,event_day, event_aluno, event_prof, event_func FROM $db_table WHERE event_month='$month' AND event_year='$year' AND event_aluno='$user' OR event_month='$month' AND event_year='$year' AND event_prof='$user' OR event_month='$month' AND event_year='$year' AND event_aluno='$user' ORDER BY event_time";
...
<div align="center"><br>
  <table width="645" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <td width="250"><div align="right"><a href="<?php echo "index.php?month=$prev_month&amp;year=$prev_year"; ?>">&lt;&lt;</a></div></td>
      ...
      <td width="195"><div align="left"><a href="<? echo "index.php?month=$next_month&amp;year=$next_year"; ?>">&gt;&gt;</a></div></td>
    </tr>
  </table>
  <br>
</div>
