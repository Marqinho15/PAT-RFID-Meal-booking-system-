...
if ($_POST['cadastrar']) {
	...
	if (!empty($foto["name"])) {
		...
		if (count($error) == 0) {
        	...
        	$caminho_imagem = "I:\PAT Criacao Sistema Almocos RFID\wamp\www\\fotos_func\\"  . $nome_imagem;
 
			// Faz o upload da imagem para seu respectivo caminho
			move_uploaded_file($foto["tmp_name"], $caminho_imagem);
 
			// Insere os dados no banco
			$sql = mysql_query("INSERT INTO funcionarios VALUES ('".$rfid."', '".$proc."', '".$nome."', '".$password."', '".$nome_imagem."')");
