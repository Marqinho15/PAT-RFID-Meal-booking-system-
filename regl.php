...
<div id="box">
   ...
   <div id="header">
    ...
    <div id="content">
    	...
    	<div id="conteudo">
        <h1>Regulamento Senhas INED</h1>
        </br>
        <p> Marcação de Refeições </p>
        <p> Cada usuário (Aluno/Professor/Funcionário) pode marcar as suas refeições na escola através deste WebSite.</p>
        <p> As Refeições têm que ser marcadas com um minimo de dois dias de antecedência e um máximo de 14.</p>
        <p> Para desmarcar senhas tem que o fazer com mais de 1 dia de antecedência.</p>
        <p> Cada pessoa pode falhar um máximo de 4  senhas, sendo que após isso terá a possibilidade de marcar as refeições bloqueadas.</p>
        <p> Todas as semanas têm a ementa disponível (colocada a partir da sexta da semana anterior).</p>                        
